...
public class HongbaoHistoryAdapter extends BaseAdapter 
{
    ...
    public HongbaoHistoryAdapter(Context context)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		if(convertView == null)
		{
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.shop_hongbao_history_item, null);
			viewHolder.moneyIcon=(TextView) convertView.findViewById(R.id.moneyIcon);
			viewHolder.moneyAction=(TextView) convertView.findViewById(R.id.moneyAction);
			...
			viewHolder.getDataText=(TextView) convertView.findViewById(R.id.getDataText);
