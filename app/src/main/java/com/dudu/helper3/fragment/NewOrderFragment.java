...
import com.dudu.helper3.bean.OrderBean;
...
public class NewOrderFragment extends Fragment 
{
	...
	public View onCreateView(LayoutInflater inflater,@Nullable ViewGroup container, @Nullable Bundle savedInstanceState) 
	{
		...
		NewOrderFragment= inflater.inflate(R.layout.fragment_order_all, null);
	...
	private void initData() 
	{
        ...
        client.get(ConstantParamPhone.IP+ConstantParamPhone.GET_NEWORDER_LIST, params,new TextHttpResponseHandler()
		{
	...
	private void initFragmentView() 
	{
		...
		// TODO Auto-generated method stub
		reloadButton=(Button) NewOrderFragment.findViewById(R.id.reloadButton);
		//数据重载按钮
		...
		allOrderListView=(ListView) NewOrderFragment.findViewById(R.id.allOrderListView);
		//allOrderListView.addFooterView(footView);
		...
		orderallswipeLayout = (SwipeRefreshLayout)NewOrderFragment.findViewById(R.id.orderallswipeLayout);
