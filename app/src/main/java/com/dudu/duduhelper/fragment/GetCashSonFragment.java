...
public class GetCashSonFragment extends Fragment 
{
	private String type;
	...
	public View onCreateView(LayoutInflater inflater,@Nullable ViewGroup container, @Nullable Bundle savedInstanceState) 
	{
		...
		GetCashSonFragmentView= inflater.inflate(R.layout.fragment_getcashson_layout, null);
	...
	private void initFragmentView() 
	{
		...
		// TODO Auto-generated method stub
		reloadButton=(Button) GetCashSonFragmentView.findViewById(R.id.reloadButton);
		//数据重载按钮
		...
		getCashSwipeLayout=(SwipeRefreshLayout) getActivity().findViewById(R.id.getCashSwipeLayout);
		...
		getCashListView=(ListView) getActivity().findViewById(R.id.getCashListView);
