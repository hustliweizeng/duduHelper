...
public class GetCashSonFragment2 extends Fragment 
{
	...
	public View onCreateView(LayoutInflater inflater,@Nullable ViewGroup container, @Nullable Bundle savedInstanceState) 
	{
		...
		GetCashSonFragmentView= inflater.inflate(R.layout.fragment_getcashson2_layout, null);
	...
	private void initFragmentView() 
	{
		...
		// TODO Auto-generated method stub
		reloadButton=(Button) GetCashSonFragmentView.findViewById(R.id.reloadButton2);
		//数据重载按钮
		...
		getCashSwipeLayout=(SwipeRefreshLayout) getActivity().findViewById(R.id.getCashSwipeLayout2);
		...
		getCashListView=(ListView) getActivity().findViewById(R.id.getCashListView2);
