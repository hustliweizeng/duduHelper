...
public class WheelIndicatorTongjiView extends View 
{
    ...
    public WheelIndicatorTongjiView(Context context, AttributeSet attrs, int defStyleAttr)
    {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public WheelIndicatorTongjiView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs);
    }

    public WheelIndicatorTongjiView(Context context)
    {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs)
    {
        ...
        //设置外面的虚线画笔
        innerBackgroundXuxianCirclePaint = new Paint();
        innerBackgroundXuxianCirclePaint.setColor(Color.parseColor("#6a7c8f"));
        innerBackgroundXuxianCirclePaint.setStyle(Paint.Style.STROKE);
        innerBackgroundXuxianCirclePaint.setStrokeWidth(itemsLineWidth * 3);
        //设置绘制画笔的虚线与虚线的间隔
        PathEffect effects = new DashPathEffect(new float[]{1,10,1,10},1);  
        innerBackgroundXuxianCirclePaint.setPathEffect(effects);
        //开启抗锯齿
        innerBackgroundXuxianCirclePaint.setAntiAlias(true);
    }
    ...
    {
        ObjectAnimator animation = ObjectAnimator.ofInt(WheelIndicatorTongjiView.this, "filledPercent", 0, filledPercent);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (circleBackgroundPaint != null)
        	...
        	//画灰色背景圆圈
        	canvas.drawArc(wheelBoundsXuxianRectF, ANGLE_INIT_OFFSET, 360, false, innerBackgroundXuxianCirclePaint);
