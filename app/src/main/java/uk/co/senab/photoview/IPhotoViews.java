...
public interface IPhotoViews {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PhotoViewAttachers.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PhotoViewAttachers.OnPhotoTapListener listener);
     ...
     */
    PhotoViewAttachers.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PhotoViewAttachers.OnViewTapListener listener);
     ...
     */
    PhotoViewAttachers.OnViewTapListener getOnViewTapListener();
     ...
     */
    IPhotoViews getIPhotoViewImplementation();
